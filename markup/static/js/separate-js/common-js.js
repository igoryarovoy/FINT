...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=acbbfcaa5e00cae039386966f3e13378)
 * Config saved to config.json and https://gist.github.com/acbbfcaa5e00cae039386966f3e13378
 */
...
+function ($) {
	...
	function QuickV() {
        this.wrapper        =  '.js-panel-group';
		this.panel          =  '.js-quick-view';
		this.card           =  '.js-card-quick-view';
		this.panelCor       =  'corner';		
	};

	QuickV.prototype.setWidthPanel = function() {	
		var $self = this;	
		var width = $($self.wrapper).outerWidth();
		$($self.panel).outerWidth(width);			
	};

	QuickV.prototype.setPositionPanel = function() {		
		var $self = this;		
		$($self.panel).each(function(){
			var posLeft = $(this).position().left;			
			$(this).css('marginLeft', - posLeft);				
		});
	};

	QuickV.prototype.addCor = function() {		
		var $self = this;

		$($self.card).each(function() {
			var $this = $(this);

			$self.cor = $('<span/>', {
				class: $self.panelCor				
			}).prependTo($this.find($self.panel));
		});

	};

	QuickV.prototype.posCor = function() {		
		var $self = this;
	...
	QuickV.prototype.start = function() {	
		var $self = this;			
		$self.posCor();
		$self.setWidthPanel();
		$self.setPositionPanel();
	};	
